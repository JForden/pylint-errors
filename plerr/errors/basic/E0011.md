...
Occurs when the special class method `__init__` is turned into a generator by a
yield in its body. If you are encountering this error, please contact a TA for further help.
